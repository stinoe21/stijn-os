...
const TIPS = [
  'Hoi! Ik ben Clippy. 📎 Het lijkt erop dat je iemands persoonlijke ontwikkeling aan het bekijken bent. Klik op een icoon om te beginnen!',
  'Tip: rechtsboven kleurt de criteria-meter in — zo zie je welke beoordelingscriteria al langs zijn gekomen.',
  'Op zoek naar bewijs? Kijk eens in Keynote.exe, Netwerk.app en Boekhouding.xls.',
  'Vergeet Update v2.0 niet — daar staan de nieuwe leerdoelen.',
  'Psst… deze hele OS heeft Stijn zélf gebouwd. Best knap voor iemand zonder software-opleiding, toch?',
]
