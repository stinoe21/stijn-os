...
/**
 * Meter met de vijf beoordelingscriteria. Een criterium "kleurt in" zodra een
 * venster is geopend dat dat criterium afdekt. Maakt voor de beoordelaar in één
 * oogopslag zichtbaar dat alle criteria aan bod komen.
 */
export default function CriteriaMeter({ seen }: { seen: Set<CriterionId> }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="flex gap-1" role="group" aria-label={`Beoordelingscriteria: ${done} van 5 bekeken`}>
        {CRITERIA.map((c) => {
